<x-app-layout>
    ...
    <div class="py-12 bg-[#f8fafc] dark:bg-gray-900 min-h-screen">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow-xl sm:rounded-[2.5rem] border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div class="p-10">
                    <form action="{{ route('kelola_akun.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            <x-input-label for="role" :value="__('Role / Jabatan')" class="font-bold text-gray-700" />
                            <select name="role" id="role" class="block mt-1 w-full border-gray-200 rounded-2xl" onchange="toggleNisn(this.value)">
                        ...
                        <div id="nisn_field" class="mb-6 hidden transition-all duration-300">
                            <x-input-label for="nisn" :value="__('NISN Siswa')" class="font-bold text-gray-700" />
                            <x-text-input id="nisn" name="nisn" type="text" class="block mt-1 w-full" :value="old('nisn')" />
                        ...
                        <div class="flex items-center justify-end">
                            <button type="submit" class="bg-indigo-600 text-white px-8 py-4 rounded-2xl font-black shadow-lg">
                                Daftarkan Akun Baru
                            </button>
                        </div>
                    </form>
