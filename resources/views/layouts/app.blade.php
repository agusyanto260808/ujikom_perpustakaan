...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (bellButton) {
        bellButton.addEventListener('click', function() {
            // 1. Sembunyikan badge di layar secara instan
            if (badge) {
                badge.style.display = 'none';
            }

            // 2. Kirim perintah ke server untuk update status 'is_read' di database
            ...
            .then(data => console.log('Notifikasi ditandai telah dibaca'))
